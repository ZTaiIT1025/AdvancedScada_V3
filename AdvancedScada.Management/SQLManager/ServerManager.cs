...
namespace AdvancedScada.Management.SQLManager
{
    public class ServerManager
    {
        ...
        public GetErorrPLC eventGetErorrPLC;
        ...
        public Server IsExisted(Server ch)
        {
            ...
            catch (Exception ex)
            {
                if (eventGetErorrPLC != null)
                    eventGetErorrPLC(GetType().Name, string.Format("+ ERROR: {0}" + Environment.NewLine, ex.Message));
            }
        ...
        public void Delete(int chId)
        {
            ...
            {
                if (eventGetErorrPLC != null)
                    eventGetErorrPLC(GetType().Name, ex.Message);
            }
        }
