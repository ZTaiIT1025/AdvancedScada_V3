...
namespace AdvancedScada.XModbus.Core.UserEditors
{
    public partial class XUserDataBlockForm : AdvancedScada.Management.Editors.XDataBlockForm
    {
        ...
        private void XUserDataBlockForm_Load(object sender, EventArgs e)
        {
            ...
            {
                var err = new ErorrPLC.ErorrPLC(this.GetType().Name + ".UserEditors.Load", ex.Message);
            }
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                var err = new ErorrPLC.ErorrPLC(this.GetType().Name + ".UserEditors.btnOK_Click", ex.Message);
            }
        }
        ...
        private void chkCreateTag_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                txtPrefix.Enabled = chkCreateTag.Checked;
            }
            catch (Exception ex)
            {
                var err = new ErorrPLC.ErorrPLC(this.GetType().Name + ".chkCreateTag_CheckedChanged", ex.Message);
            }
        }
        ...
        private void cboxDataType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var err = new ErorrPLC.ErorrPLC(this.GetType().Name + ".cboxDataType_SelectedIndexChanged", ex.Message);
